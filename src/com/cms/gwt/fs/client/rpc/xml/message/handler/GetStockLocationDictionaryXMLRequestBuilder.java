...
public class GetStockLocationDictionaryXMLRequestBuilder extends XmlRequestBuilder implements RequestBuilder, Instantiable {

	final private String XML_REQUEST_NAME = "getBinByStockLocationList";
	
	final private String RESPONSE_HANDLER_NAME = ReceiveStockLocationDictionaryXMLResponseHandler.class.getName();
