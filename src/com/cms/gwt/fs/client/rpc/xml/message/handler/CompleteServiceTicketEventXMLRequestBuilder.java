...
public class CompleteServiceTicketEventXMLRequestBuilder extends XmlRequestBuilder implements RequestBuilder, Instantiable {

	final static private String XML_REQUEST_NAME = "completeServiceTicketEvent";
	
	final static protected String XML_RESPONSE_HANDLER = CompleteServiceTicketEventXMLResponseHandler.class.getName();
	...
	{	
		CompleteServiceTicketEvent currAction = (CompleteServiceTicketEvent)action;
