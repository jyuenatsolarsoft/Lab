...
public class SaveRecordedLabourListXMLResponseHandler extends ServiceXMLResponseHandler implements Instantiable
{
	@Override
	protected ActionResponse constructResponse(Messages msgs) {
		return new SaveRecordedLabourListResponse(msgs);
	}			
}